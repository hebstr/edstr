...
**Source re-matching.**
After token-level matching on ASCII-transliterated n-grams, patterns are re-matched against the original text with accent normalisation.
Discrepancies between the two are flagged as mismatches for review.
