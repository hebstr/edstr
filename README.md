...
fichier de configuration généré par `edstr_config()`. Elle peut prendre
comme input n’importe quelle table, du moment que celle-ci contient a
minima une colonne identifiant et une colonne texte.
